...
/**
 * Expose `Calendar` and `Days`.
 */

module.exports = Calendar;
Calendar.Days = Days;

Calendar.setMonths = function (months) {
  Days.setMonths(months);
};

Calendar.setDays = function (days) {
  Days.setDays(days);
};
...
function Calendar(date) {
  ...
  this.days.on('today', this.today.bind(this));
 ...
 * @api public
 */
Calendar.prototype.today = function (date) {
  date = date || new Date();
  this.days.select(date);
  this.show(date);
  this.emit('view change', this.days.selectedMonth(), 'today');
  return this;
};
 ...
 * 
 * @param {Object} events
 * @param {Function} [formater] custom formater
 * @return {Calendar}
 * @api public
 */

Calendar.prototype.showEvents = function (events, formater) {
  this.days.showEvents(events, formater);
  return this;
};

Calendar.prototype.range = function () {
  return this.days.range();
};
